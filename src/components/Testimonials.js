  ...
  return (
    <>
      <div className="flex-this-cards">
        <TestimonialCard src="t1.jpg" text="La început eram sceptică dar am rămas surprinsă când am inceput să văd schimbari în viața mea de zi cu zi." nume="Andrea Rea"/>
